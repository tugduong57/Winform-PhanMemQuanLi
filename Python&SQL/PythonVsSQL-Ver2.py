...
def C_database():
	...
	# Tạo bảng Đơn vị tính của từng sản phẩm
	create_dvtSanPham = '''
		if not exists ( select * from sysobjects where name = 'dvtSanPham' and xtype = 'U')
		begin
			create table dvtSanPham (
	...
	cursor.execute(create_dvtSanPham)
