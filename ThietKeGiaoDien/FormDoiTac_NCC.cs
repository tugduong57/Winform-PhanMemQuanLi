    ...
    public partial class FormDoiTac_NCC : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            string lenhSQL = "INSERT INTO DoiTac ([Mã đối tác], [Tên đối tác], [Phân loại], [Tuổi], [Địa chỉ], [Số điện thoại], [Ghi chú])" +
                             " VALUES (@maDoiTac, @tenDoiTac, N'Nhà cung cấp', @tuoi, @DiaChi, @Sdt, @ghiChu)";
        ...
        private void btnSua_Click(object sender, EventArgs e)
        {
            ...
            string tenDoiTac = tb_TenDT.Text;
            string tuoi = tb_Tuoi.Text;
            ...
            try
            {
                ...
                if (rowsAffected > 0)
                {
                    ...
                    FormDoiTac_NCC_Load(sender, e); // Load lại dữ liệu
                    ClearFields();
                }
                else
                {
